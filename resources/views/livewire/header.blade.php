    ...
    <header class="header" role="banner">
        <div class="header-content">
            <a href="{{ route('home') }}" class="logo logo-link">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 444 453"
                     style="enable-background:new 0 0 444 453;" class="logo-image">
                    <style type="text/css">
                        svg { background-color:#fecb00;}
                        .st0{fill:#1a3050;}
                        @media (prefers-color-scheme: dark) {
                            svg { background-color:#1a3050;}
                            .st0{fill:#fecb00;}
                        }
                    </style>
