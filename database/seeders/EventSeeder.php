        ...
        $events = [
            [
                ...
                'organizers' => [
                    ...
                    ['name' => 'Oderland', 'description' => 'Oderland is a Swedish web hosting company that provides specialized hosting services for Laravel applications.'],
                ],
                'closing' => 'We hope to see you at the first Laravel meetup in Norrköping!',
            ],
            [
                'title' => 'Laravel Meetup Stockholm',
                'datetime' => '2025-10-01 17:00:00',
                ...
                'organizers' => [
                    ['name' => 'Kameo', 'description' => 'Kameo is an investment platform that enables both private individuals and institutional investors to invest in secured loans for real estate projects in Scandinavia. They use Laravel to build stable and reliable systems that meet high demands for security and scalability.'],
                    ['name' => 'Techlove', 'description' => 'Techlove supports businesses all the way from prototype to full-scale business systems, focusing on smart development, business value, and an active developer community around Laravel and PHP.'],
                    ['name' => 'Swedish Laravel Association', 'description' => 'Community hub for Laravel developers in Sweden'],
                ],
            ...
            [
                ...
                'organizers' => [
                    ['name' => 'Caesar', 'description' => 'Caesar works with strategy, design and programming and helps your company develop value-creating digital services, websites and applications.'],
                    ['name' => 'Swedish Laravel Association', 'description' => 'Community hub for Laravel developers in Sweden'],
                ],
